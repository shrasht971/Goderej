    ...
    <div className="flex flex-col md:flex-row h-[70vh] lg:h-[48vh] md:h-[48vh] custom-lg:h-[54vh] 3xl:h-[47vh]">
      <div className="w-full md:w-2/6 p-4 flex flex-col justify-center items-center relative bg-white ">
        <img 
          src={Image} 
          alt="Explore" 
          className="w-full h-2/3 md:h-full object-cover shadow-lg" 
        />
        <button className="absolute bottom-4 md:bottom-10 px-4 md:px-6 py-2 md:py-3 bg-blue-600 text-white rounded-md shadow-md hover:bg-blue-700 transition duration-300 ease-in-out">
          Explore
        </button>
      </div>
